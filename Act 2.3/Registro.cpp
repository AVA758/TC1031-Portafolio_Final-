...
// Constructor
// Establece los elementos de la información que tendrá un registro
Registro::Registro() {
  mes = "";
  dia = "";
  horas = "";
...
// getAll
// Regresa un string que contiene el mes, día, hora, 
// minuto, segundo, dirección ip, puerto y mensaje
// de falla de la entrada del registro.
// Complejidad: O(1)
